...
$attributeRepository = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(\Magento\Eav\Api\AttributeRepositoryInterface::class);
...
$imagesGenerator = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Setup\Fixtures\ImagesGenerator\ImagesGenerator::class);
/** @var SwatchesMedia $swatchesMedia */
$swatchesMedia = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Swatches\Helper\Media::class);
...
$data['swatch_input_type'] = \Magento\Swatches\Model\Swatch::SWATCH_INPUT_TYPE_VISUAL;
...
$data['optionvisual']['value'] = array_reduce(
    ...
    function ($values, $index) use ($optionsPerAttribute) { // @codingStandardsIgnoreLine
...
foreach ($data['options']['option'] as $optionData) {
    $options[] = \Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(\Magento\Eav\Api\Data\AttributeOptionInterface::class)
